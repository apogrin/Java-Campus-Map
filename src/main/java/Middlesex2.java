...
/**
 *  This class represents Middlesex2 frame
 * @author louie
 */
//Components
public class Middlesex2 extends javax.swing.JFrame {
     ...
     */
    public Middlesex2(LinkedList<String> ll) {
        initComponents();
        this.createButtonsFromJSON("dataFiles/POI.json", ll);
    }
...
//
    ...
    private void initComponents() {
        ...
        map.setIcon(new javax.swing.ImageIcon("images/Middlesex2.png"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new Middlesex2(selected).setVisible(true);
        this.dispose();
    ...
    public void addPoiPopUp(int[] coordinates) {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            try (FileReader reader = new FileReader("dataFiles/POI.json")) {
                ...
                POI addPoi = new POI(layer, roomNum, name, coordinates, 2, false);  //HEREEEE
