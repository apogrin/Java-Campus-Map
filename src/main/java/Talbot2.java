...
/**
 * This class represents Talbot2 frame
 * @author louie
 */
//Components
                            ...
                            if (LoginFrame.isDev) {
                                ...
                                if (result == 0) {
                                    ...
                                    if (res == JOptionPane.OK_OPTION) {
                                        ...
                                        new Talbot2(ll).setVisible(true);
                                    }
                                } else if (result == 4) {
...
//
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Talbot College Floor 2");
        ...
        SelectFloorBox1.setSelectedIndex(1);
        ...
        map.setIcon(new javax.swing.ImageIcon("images/Talbot2.png"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new Talbot2(selected).setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Talbot2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
