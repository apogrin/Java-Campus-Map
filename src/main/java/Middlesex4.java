 ...
 */
//Components
public class Middlesex4 extends javax.swing.JFrame {
     ...
     */
    public Middlesex4(LinkedList<String> ll) {
        initComponents();
        this.createButtonsFromJSON("dataFiles/POI.json", ll);
    }
    /**
...
//
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Middlesex College Floor 4");
        ...
        map.setIcon(new javax.swing.ImageIcon("images/Middlesex4.png"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new Middlesex4(selected).setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Middlesex4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
