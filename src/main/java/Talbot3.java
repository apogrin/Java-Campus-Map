...
/**
 * This class represents Talbot3 frame
 * @author louie
 */
//Components
public class Talbot3 extends javax.swing.JFrame {
     ...
     */
    public Talbot3(LinkedList<String> ll) {
        initComponents();
        this.createButtonsFromJSON("dataFiles/POI.json", ll);
    }
    /**
...
//
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Talbot College Floor 3");
        ...
        map.setIcon(new javax.swing.ImageIcon("images/Talbot3.png"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new Talbot3(selected).setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Talbot3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
