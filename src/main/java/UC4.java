...
/**
 * This class represents UC4 frame
 * @author louie
 */
//Components
public class UC4 extends javax.swing.JFrame {
     ...
     */
    public UC4(LinkedList<String> ll) {
        initComponents();
        this.createButtonsFromJSON("dataFiles/POI.json", ll);
    }
    /**
     ...
     */
     public void createButtonsFromJSON(String jsonFilePath, LinkedList<String> ll) {
        ...
        try (FileReader reader = new FileReader(jsonFilePath)) {
            ...
            JSONArray pointsOfInterest = uc.getJSONArray("points_of_interest");
...
//
    ...
    private void initComponents() {
        ...
        jLabel4.setText("University College Floor 4");
        ...
        map.setIcon(new javax.swing.ImageIcon("images/UC4.png"));
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        SearchFunc search = new SearchFunc(searchTerm, "dataFiles/POI.json", 1, map, searchBarTextField, this);      
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new UC4(selected).setVisible(true);
        this.dispose();
