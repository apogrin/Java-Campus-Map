...
/**
 * This class represents UC3 frame
 * @author louie
 */
//Components
public class UC3 extends javax.swing.JFrame {
     ...
     */
    public UC3(LinkedList<String> ll) {
        initComponents();
        this.createButtonsFromJSON("dataFiles/POI.json", ll);
    }
    /**
...
//
    ...
    private void initComponents() {
        ...
        jLabel4.setText("University College Floor 3");
        ...
        map.setIcon(new javax.swing.ImageIcon("images/UC3.png"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new UC3(selected).setVisible(true);
        this.dispose();
