...
/**
 * This class represents UC2 frame
 * @author louie
 */
//Components
public class UC2 extends javax.swing.JFrame {
     ...
     */
    public UC2(LinkedList<String> ll) {
        initComponents();
        this.createButtonsFromJSON("dataFiles/POI.json", ll);
    }
    /**
...
//
    ...
    private void initComponents() {
        ...
        jLabel4.setText("University College Floor 2");
        ...
        map.setIcon(new javax.swing.ImageIcon("images/UC2.png"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new UC2(selected).setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UC2
