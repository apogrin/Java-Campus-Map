...
/**
 * This class represents UC1 frame
 * @author louie
 */
//Components
public class UC1 extends javax.swing.JFrame {
     ...
     */
    public UC1(LinkedList<String> ll) {
        initComponents();
        this.createButtonsFromJSON("dataFiles/POI.json", ll);
    }
    /**
...
//
    ...
    private void initComponents() {
        ...
        jLabel4.setText("University College Floor 1");
        ...
        map.setIcon(new javax.swing.ImageIcon("images/UC1.png"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new UC1(selected).setVisible(true);
        this.dispose();
