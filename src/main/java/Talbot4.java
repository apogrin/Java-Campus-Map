 ...
 */
//Components
public class Talbot4 extends javax.swing.JFrame {
     ...
     */
    public Talbot4(LinkedList<String> ll) {
        initComponents();
        this.createButtonsFromJSON("dataFiles/POI.json", ll);
    }
    /**
                            ...
                            if (LoginFrame.isDev) {
                                ...
                                if (result == 0) {
                                    ...
                                    if (res == JOptionPane.OK_OPTION) {
                                        ...
                                        new Talbot4(ll).setVisible(true);
                                    }
                                } else if (result == 4) {
...
//
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Talbot College Floor 4");
        ...
        SelectFloorBox1.setSelectedIndex(3);
        ...
        map.setIcon(new javax.swing.ImageIcon("images/Talbot4.png"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new Talbot4(selected).setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Talbot4
