...
/**
 * This class represents Talbot1 frame
 * @author louie
 */
//Components
public class Talbot1 extends javax.swing.JFrame {
     ...
     */
    public Talbot1(LinkedList<String> ll) {
        initComponents();
        this.createButtonsFromJSON("dataFiles/POI.json", ll);
    }
    /**
                            ...
                            if (LoginFrame.isDev) {
                                ...
                                if (result == 0) {
                                    ...
                                    if (res == JOptionPane.OK_OPTION) {
                                        ...
                                        new Talbot1(ll).setVisible(true);
                                    }
                                } else if (result == 4) {
...
//
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Talbot College Floor 1");
        ...
        SelectFloorBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Floor 1", "Floor 2", "Floor 3", "Floor 4" }));
        ...
        map.setIcon(new javax.swing.ImageIcon("images/Talbot1.png"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new Talbot1(selected).setVisible(true);
        this.dispose();
    ...
    public void addPoiPopUp(int[] coordinates) {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            try (FileReader reader = new FileReader("dataFiles/POI.json")) {
                ...
                JSONArray buildings = json.getJSONArray("buildings");
                JSONObject talbot = buildings.getJSONObject(2);
                JSONArray pois = talbot.getJSONArray("points_of_interest");
                String layer = "";
                if (LoginFrame.isDev) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Talbot1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
