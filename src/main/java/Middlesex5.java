...
/**
 * This class represents Middlesex5 frame
 * @author louie
 */
//Components
public class Middlesex5 extends javax.swing.JFrame {
     ...
     */
    public Middlesex5(LinkedList<String> ll) {
        initComponents();
        this.createButtonsFromJSON("dataFiles/POI.json", ll);
    }
    /**
                            ...
                            if (LoginFrame.isDev) {
                                ...
                                if (result == 0) {
                                    ...
                                    if (res == JOptionPane.OK_OPTION) {
                                        ...
                                        new Middlesex5(ll).setVisible(true);
                                    }
                                } else if (result == 4) {
...
//
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Middlesex College Floor 5");
        ...
        map.setIcon(new javax.swing.ImageIcon("images/Middlesex5.png"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        new Middlesex5(selected).setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Middlesex5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
